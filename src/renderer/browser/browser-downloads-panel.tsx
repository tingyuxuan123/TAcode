  ...
  return (
    <div className="browser-downloads-panel">
      <div className="browser-downloads-header">
        ...
        <button type="button" className="browser-downloads-close" onClick={onClose} aria-label={t("browser.downloadsClose")}>
              ...
              <div key={item.id} className="browser-download-item">
                  ...
                  {isActive ? (
                    <>
                      <div className="browser-download-progress">
                        <div className="browser-download-progress-bar" style={{ width: percent !== null ? `${percent}%` : "30%" }} />
                      </div>
                ...
                <div className="browser-download-actions">
                  {item.state === "completed" && item.path && (
                    <>
                      <button type="button" className="browser-download-action" title={t("browser.openFile")} onClick={() => onOpen(item.id)}>
                        {t("browser.openFile")}
                      </button>
                      <button type="button" className="browser-download-action" title={t("browser.showInFolder")} onClick={() => onShowInFolder(item.id)}>
                        <FolderOpen size={13} strokeWidth={1.8} />
                      </button>
                    </>
                  )}
                  {isActive && (
                    <button type="button" className="browser-download-action" title={t("browser.downloadCancel")} onClick={() => onCancel(item.id)}>
