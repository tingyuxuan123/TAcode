...
const zh = {
  ...
  "settings.themePreviewBot": "项目已就绪。Hello, Tether! 已整理 12 个文件，保留原有的 README、测试与配置。",
...
const en: Record<MessageKey, string> = {
  ...
  "settings.themePreviewBot": "The project is ready. Hello, Tether! Numbers: 0123456789. Punctuation: (),.!?",
