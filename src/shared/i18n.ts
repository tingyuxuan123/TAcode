...
const en: Record<MessageKey, string> = {
  ...
  "settings.styleHint": "Based on the provider's adapter guide; only change when the endpoint differs.",
  ...
  "settings.modelsHint": "Models are auto-discovered after entering the Base URL and API key. Check the ones you want to enable.",
